        ...
        <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
          <div className="flex flex-col items-center space-x-2 pt-8 xl:sticky xl:top-0">
            ...
            <div className="flex space-x-3 pt-6">
              ...
              <SocialIcon kind="website" href={`https://mgates.vercel.app`} size="6" />
            </div>
          </div>
          <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2 text-center">
            <p>
              <RoughNotation
                type="bracket"
                brackets={['left', 'right']}
                ...
                <ul>
                  ...
                  <li>
                    <Link
                      ...
                      className="special-underline no-underline hover:text-gray-100 dark:text-gray-100 hover:dark:text-gray-100"
                    >
                      Path Desai's fork of the above template
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        className="ml-0.5 inline-block h-4 w-4 fill-current"
