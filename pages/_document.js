    ...
    return (
      <Html lang="en" className="scroll-smooth">
        <Head>
          ...
          <meta
            name="description"
            content="Welcome to my personal blog where I share my musings. I am a Software Engineer passionate about frontend tech, building pipelines and automation."
          />
